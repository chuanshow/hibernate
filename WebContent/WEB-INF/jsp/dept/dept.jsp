	...
	<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
				...
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					<td><input type="checkbox" id="box_${stat.index}" value="${dept.dId}"></td>
					 <td>${dept.dName }</td>
					  <td>${dept.dRemark }</td>
					 <%if("1".equals(user.getFlag())){ %>
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/dept/updateDept.action?flag=1&dId=${dept.dId}">
	  ...
	  <tr valign="top"><td align="center" class="font3">
	  	 <fkjava:pager
	  	        ...
	  	        style="digg"
	  	        submitUrl="${pageContext.request.contextPath}/dept/selectDept.action?pageIndex={0}"/>
	  </td></tr>
	</table>
