...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/dept/updateDept1.action" id="deptForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">部门名称：<input type="text" name="dName" id="dName" size="20" value="${dept.dName }"/></td>
		    			<td class="font3 fftd">详细描述：<input type="text" name="dRemark" id="dRemark" size="20" value="${dept.dRemark }"/></td>
		    		</tr>
		    	</table>
		    </td></tr>
