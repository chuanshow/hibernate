...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/user/updateUser1.action" id="userForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		    ...
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			...
		    			<td class="font3 fftd">状态：<input type="text" name="uStatus" id="uStatus" size="20" value="${user.uStatus }"/></td>
		    		</tr>
		    			
		    		<tr>
		    			<td class="font3 fftd">登录名：<input name="loginName" id="loginName" size="20" value="${user.loginName }"/></td>
		    			<td class="font3 fftd">密&nbsp;码：<input name="uPassword" id="uPassword" size="20" value="${user.uPassword }"/></td>
		    		</tr>
