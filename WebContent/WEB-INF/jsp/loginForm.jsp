   ...
   $(function(){
	   ...
	   $("#login-submit-btn").on("click",function(){
		   ...
		   if(!/^\w{4,20}$/.test(loginName)){
			     msg = "登录名长度必须是6~20之间";
		   }else if(!/^\w{4,20}$/.test(uPassword)){
			     msg = "密码长度必须是6~20之间或者密码错误";
		   }
		   if(msg !=""){
	...
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px">
			<a class="brand" href="login.html"
				style="font-size: 22px; color: #FFF;"> 企业员工信息管理<font color="#FFCC00">Hrm</font><span
		...
		<form action="login.action" method="post" id="loginForm">
			<div class="page-body">
				<img class="page-lock-img"
					src="${pageContext.request.contextPath}/js/metronic/img/profile/logo5.jpg" alt="">
						...
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-lock"></i> <input
									...
									placeholder="密码" id="uPassword" name="uPassword"
									value="${uPassword}">
							</div>
						</div>
					</div>
