		...
		<table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
		  ...
		  <tr valign="top" id="submenu6" style="display: none">
		    <td class="left_nav_bgshw tdbtmline" height="50">
			  ...
			  <p class="left_nav_link"><img src="${pageContext.request.contextPath}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/flows/doFlows.action"  target="main">流程审批</a></img></p>
		  ...
		  <tr><td height="2"></td></tr>
		  <tr><td id="navbg7" class="left_nav_closed" ><div class="font1">权限管理</div></td></tr>
		  <tr valign="top" id="submenu7" style="display: none">
		    <td class="left_nav_bgshw tdbtmline" height="50">
			  <p class="left_nav_link"><img src="${pageContext.request.contextPath}/images/left_nav_arrow.gif">&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/flows/authorization.action" target="main">用户授权</a></img></p>
			</td>
		  </tr>
