			  ...
			  <td class="fftd">
			  	<form name="noticeform" method="post" id="noticeform" action="${pageContext.request.contextPath}/notice/selectNotice.action">
				    <table width="100%" border="0" cellpadding="0" cellspacing="0">
					  <tr>
					    <td class="font3">
					    	公告名称：<input type="text" name="nTitle">
				...
				<tr id="data_${stat.index}" align="center" class="main_trbg" onMouseOver="move(this);" onMouseOut="out(this);">
					<td><input type="checkbox" id="box_${stat.index}" value="${notice.nId}"></td>
					 <td>${notice.nTitle }</td>
					  ...
					  <td>
					  <f:formatDate value="${notice.nDate}" 
								type="date" dateStyle="long"/>
					  </td>
					  <td>${notice.user.userName }</td>
					    <%if("1".equals(user.getFlag())){ %>
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath }/notice/updateNotice.action?flag=1&nId=${notice.nId}">
