				...
				<tr id="data_${stat.index}" class="main_trbg" align="center">
					<td><input type="checkbox" id="box_${stat.index}" value="${employee.eId}"></td>
					 <td>${employee.eName }</td>
					  ...
					  <td>
					  	<f:formatDate value="${employee.eDate}" 
								type="date" dateStyle="long"/>
					  </td>
					  <%if("1".equals(user.getFlag())){ %>
					  <td align="center" width="40px;"><a href="${pageContext.request.contextPath}/employee/updateEmployee.action?flag=1&eId=${employee.eId}">
