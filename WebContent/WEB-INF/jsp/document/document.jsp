	    ...
	    <td height="20">
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${requestScope.documents}" var="document" varStatus="stat">
				<tr ondblclick="down(${document.dId});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox" id="box_${stat.index}" value="${document.dId}"></td>
					 <td>${document.title }</td>
					 <td>
					  	<f:formatDate value="${document.dDate}" 
								type="date" dateStyle="long"/>
					  </td>
					  <td>${document.user.userName }</td>
					  <td>${document.dRemark }</td>
					  <%if("1".equals(user.getFlag())){ %>
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath }/document/updateDocument.action?flag=1&dId=${document.dId}">
							<img title="修改" src="${pageContext.request.contextPath }/images/update.gif"/></a>
					  </td>
					  <%} %>
					  <td align="center"  width="40px;"><a href="#" id="down_${document.dId }">
